...
namespace smd_utils {
    ...
    // NOTE: getIconFromTitleId has been removed - duplicate of GenericToolbox::Switch::Utils::getIconFromTitleId
    // Use GenericToolbox::Switch::Utils::getIconFromTitleId instead
    ...
    std::string getModInstallPath() {
            // Always use "mods" folder for mod downloads
            return "mods";
    }
